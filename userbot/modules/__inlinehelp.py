...
async def yardim(event):
    try:
        ...
        if kenbotusername is not None:
            results = await event.client.inline_query(kenbotusername, "@KenProject")
            ...
            await event.edit(
                "`Botnya tidak berfungsi! Silahkan atur Bot Token dan Bot Username dengan benar. Modul telah dihentikan.`"
            )
    except Exception:

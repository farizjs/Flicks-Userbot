...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (KennedyProject/KEN-UBOT)",
        ...
        "INFO - KennedyProject: Logged in as 557667062",
        "INFO - KennedyProject: Successfully...",
        "919852+00:00 app[worker.1]: 919 - KennedyProject -",
        "INFO - ♨️KEN-UBOT♨️ ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"

...
@flicks_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@flicks_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/InfoFlicksUserbot:same> [Support]<buttonurl:https://t.me/FlicksSupport>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/InfoFlicksUserbot:same> [Support]<buttonurl:https://t.me/FlicksSupport>`\
    "
    }
)
